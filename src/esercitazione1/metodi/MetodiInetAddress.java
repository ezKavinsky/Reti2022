...
public class MetodiInetAddress {
    ...
    byte[] getAddress(); restituisce l'indirizzo IP sotto forma di array di byte

    String getHostAddress(); restituisce l'indirizzo IP sotto forma di stringa (es. "192.168.85.75")

    String getHostName(); restituisce l'hostname associato all'indirizzo IP

    UnknownHostException; eccezione generata quando non si riesce a trovare un host
